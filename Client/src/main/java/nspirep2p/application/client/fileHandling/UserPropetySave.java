...
public class UserPropetySave {
    ...
    public void generateConfigFile(String ip, String username) throws IOException {
        File file = new File(System.getProperty("user.home") + "/" + "login_config.json");
        if (file.exists()) file.delete();
        String[] properties = new String[]{ip, username};
